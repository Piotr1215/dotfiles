...
4. Write a short summary of the changes in markdown syntax
   - A brief summary of the changes made.
   - The reason for these changes.
   - The impact of these changes on the overall project.
5. Ensure your description is written in a "matter of fact", clear, and concise
language and short.
...
Remember, the output should be in markdown format, clear, brief, concise, and understandable even for someone who is not familiar with the project.
