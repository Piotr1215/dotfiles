...
check_vids_queue = '/home/decoder/dev/dotfiles/scripts/__check_video_download_queue.sh'
...
def append_to_playlist(playlist_file_path):
    ...
    if url not in existing_urls:
        ...
        # Initiate instance of check_vids_queue script
        subprocess.Popen([check_vids_queue])
