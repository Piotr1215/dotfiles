...
local function setup_buffer_keymaps()
  ...
  vim.keymap.set('n', '<leader>sc', M.presentation_stats, vim.tbl_extend('force', opts, { desc = "Presentation stats" }))
  
  -- Interactive reordering
  vim.keymap.set('n', '<leader>sR', M.interactive_reorder, vim.tbl_extend('force', opts, { desc = "Reorder slides interactively" }))
